...
/* Select the ports (SSCL3 and SSDA3) to use in SCI3 */
    #define R_SCI_IIC_CFG_SCI3_SSCL3_PORT   '2'        /* Port Number */  
    #define R_SCI_IIC_CFG_SCI3_SSCL3_BIT    '5'        /* Bit Number  */  

    #define R_SCI_IIC_CFG_SCI3_SSDA3_PORT   '2'        /* Port Number */  
    #define R_SCI_IIC_CFG_SCI3_SSDA3_BIT    '3'        /* Bit Number  */  
